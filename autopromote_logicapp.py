...
from logic_app_message import trigger_logic_app
...
def notify_teams(promotions, error):
    """
    Given a list of resuilts from promote_pkgs, send a message to Teams.
    """
    ...
    for attachment in attachments["fields"]:
        trigger_logic_app("autopromote","autopromote run complete",attachment['title'],attachment['value'])
